...
app.get('/team_stats', function(req, res) {
  var games = 'SELECT * FROM football_games WHERE EXTRACT(YEAR FROM game_date) = 2018';
  var wins = 'SELECT COUNT(*) FROM football_games WHERE EXTRACT(YEAR FROM game_date) = 2018 AND home_score > visitor_score';
  var losses = 'SELECT COUNT(*) FROM football_games WHERE EXTRACT(YEAR FROM game_date) = 2018 AND visitor_score > home_score';
